...
from .models import Appointment, Room, VisitRecording
...
@admin.register(VisitRecording)
class VisitRecordingAdmin(admin.ModelAdmin):
    list_display = (
        "id",
        "clinic",
        "appointment",
    ...
    search_fields = ("original_filename", "job_id")
    readonly_fields = (
        "job_id",
        "input_s3_key",
        "transcript",
